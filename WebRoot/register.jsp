...
<link href="<%=request.getContextPath()%>/assets/css/bootstrap.min.css"
	rel="stylesheet" />
<link
	href="<%=request.getContextPath()%>/assets/css/bootstrap-responsive.min.css"
	rel="stylesheet" />
<link rel="stylesheet"
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/css/ace-responsive.min.css" />
<link rel="stylesheet"
				...
				<div class="span12">
					<div class="login-container">
						<div class="row-fluid">
							<div class="center">
								<h1>
									<i class="icon-leaf green"></i> <span class="red">&nbsp;Welcome</span>
									<span class="white"></span>

								</h1>
								<h4 class="blue">
									&copy; <a href="http://weibo.com/2098099627" target="_blank">亚麻跌</a>
								</h4>
							</div>
						</div>
										...
										<div class="widget-main">
											...
											<c:if test="${message != null }">
												<h4 class="header red lighter bigger">
													<i class="icon-coffee green"></i> &nbsp;${message}
												</h4>
											</c:if>
											<div class="space-6"></div>

											<form action="<%=request.getContextPath()%>/registerServlet"
												method="get" id="register">
												<fieldset>
													<label> <span
														class="block input-icon input-icon-right"> <input
															type="text" class="span12" name="username"
															<c:if test="${username!=null}">value="${username}"</c:if>
															placeholder="Username" /> <i class="icon-user"></i>
													</span>
													</label> <label> <span
														class="block input-icon input-icon-right"> <input
															type="password" class="span12" name="password"
															value="123456" placeholder="Password" /> <i
															class="icon-lock"></i>
													</span>
													</label>
											...
											<div class="social-or-login center">
												<span class="bigger-110">米粒(mili)</span>
											</div>

											<div class="social-login center">
												<img alt="米粒"
													src="<%=request.getContextPath()%>/assets/images/getqrcode.jpeg"
